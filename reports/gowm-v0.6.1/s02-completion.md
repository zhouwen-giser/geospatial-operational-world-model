...
README, PROJECT_STATUS, CHANGELOG, ADR, operations runbook, VERSION/package metadata, living ExecPlan, phase reports, sync-state and final stable-candidate report are reconciled for 0.6.1.
...
See [s02-acceptance.json](s02-acceptance.json),
