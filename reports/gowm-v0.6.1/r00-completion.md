...
10 effective cases passed; 0 delivery cases pending external receipt; 0 original compatibility cases superseded by the user (not PASS). Zero failed or missing implementation cases.

Current named unit/runtime/conformance evidence: [r00-acceptance.json](r00-acceptance.json). Source fingerprint: `e36a2c67eda8c6d6104ecf67b4de917d118ca31fb53bc009a0a9f20fa3d5bcda`.
