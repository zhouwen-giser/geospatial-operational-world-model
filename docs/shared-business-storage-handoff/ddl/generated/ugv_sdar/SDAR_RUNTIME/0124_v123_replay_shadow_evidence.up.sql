CREATE TABLE ugv_sdar.promotion_provenance_report (
...
CREATE INDEX promotion_provenance_report_status_idx ON ugv_sdar.promotion_provenance_report (status, created_at, report_id);
