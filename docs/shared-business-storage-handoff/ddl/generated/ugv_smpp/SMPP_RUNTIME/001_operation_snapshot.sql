CREATE TABLE IF NOT EXISTS ugv_smpp.operation_snapshot (
...
CREATE INDEX operation_snapshot_provider_manifest_idx ON ugv_smpp.operation_snapshot (provider_id, manifest_hash);
