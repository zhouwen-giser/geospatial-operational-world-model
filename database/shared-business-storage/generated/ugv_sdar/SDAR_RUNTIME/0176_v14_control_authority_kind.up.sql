ALTER TABLE ugv_sdar.governed_control_confirmation 
  ...
  ADD CONSTRAINT governed_control_confirmation_authority_kind_check 
    CHECK (authority_kind IN ('physical_control', 'emergency_stop', 'weapon_control'));
...
INSERT INTO ugv_sdar.schema_migration (
  ...
  ('0176_v14_control_authority_kind');
