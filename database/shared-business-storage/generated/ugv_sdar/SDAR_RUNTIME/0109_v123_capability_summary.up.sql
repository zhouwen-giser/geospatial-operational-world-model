...
ALTER TABLE ugv_sdar.runtime_capability_summary 
  DROP CONSTRAINT runtime_capability_summary_catalog_hash_revision_key RESTRICT;
...
ALTER TABLE ugv_sdar.runtime_capability_limitation 
  ADD CONSTRAINT runtime_capability_limitation_reason_check 
    CHECK (reason_code IN ('missing_outcome_specification', 'internal_only', 'confirmation_required', 'not_composable', 'no_enabled_skill'));

INSERT INTO ugv_sdar.schema_migration (
  version
) VALUES
  ('0109_v123_capability_summary');
