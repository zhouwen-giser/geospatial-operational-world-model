CREATE OR REPLACE FUNCTION ugv_sdar.protect_task_capability_attempt_content() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
...
INSERT INTO ugv_sdar.schema_migration (
  ...
  ('0167_v14_task_capability_initial_plan_binding');
