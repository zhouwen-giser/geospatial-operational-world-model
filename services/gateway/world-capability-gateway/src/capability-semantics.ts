...
const OVERRIDES: Readonly<Record<string, Partial<CapabilitySemanticProfile>>> = {
  ...
  "reference.validate@1.0": { domain: "PLATFORM", acceptedReferenceKinds: ["WORLD_OBJECT", "SPATIAL_OBJECT", "DATASET", "LAYER", "LAYER_FEATURE", "QUERY_RESULT", "DERIVED_REFERENCE", "REFERENCE_SET"], relationSemantics: ["VALIDATES"], timeSemantics: "CURRENT", resultNature: "VALIDATION", negativeEvidencePolicy: "NOT_APPLICABLE", freshnessSemantics: "SNAPSHOT_CURRENTNESS" },
  "result.validate@1.0": { domain: "PLATFORM", acceptedReferenceKinds: ["WORLD_OBJECT", "SPATIAL_OBJECT", "DATASET", "LAYER", "LAYER_FEATURE", "QUERY_RESULT", "DERIVED_REFERENCE", "REFERENCE_SET"], relationSemantics: ["VALIDATES"], timeSemantics: "CURRENT", resultNature: "VALIDATION", negativeEvidencePolicy: "NOT_APPLICABLE", freshnessSemantics: "SNAPSHOT_CURRENTNESS" },
  "snapshot.get@1.0": { domain: "PLATFORM", producedReferenceKinds: ["DATASET", "LAYER", "QUERY_RESULT", "DERIVED_REFERENCE"], relationSemantics: ["READS_SNAPSHOT"], timeSemantics: "SNAPSHOT", resultNature: "VALIDATION", negativeEvidencePolicy: "NOT_APPLICABLE", freshnessSemantics: "SNAPSHOT_CURRENTNESS" },
