-- EXACT KNOWN PAIR. $1 scope,$2 A,$3 B,$4 span,$5 nominal metres.
-- tDwithin is stable only for planar tgeompoint. It respects common defined
-- domain/gaps. This returns NOMINAL intervals, not hard-bound probabilities.
WITH p AS (
...
SELECT whenTrue(tDwithin(ta,tb,$5::double precision)) proximity_times,
       getTime(ta) coverage_a,getTime(tb) coverage_b,radius_a,radius_b,'NOMINAL' uncertainty_policy
